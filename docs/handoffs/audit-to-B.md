...
- **A-25:** `blocks_floor` measures height from z = 0, but the real exports put the floor about 1.4 m lower, so beds, tables, chairs and sofas read as open floor. Lane D's `D-to-B.md` has the repro.
