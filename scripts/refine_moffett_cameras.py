...
def main():
 ...
 by_name=dict(zip(names,frames,strict=True)); images=DATA/'images'; masks=DATA/'masks'
 ...
 match=pycolmap.FeatureMatchingOptions();match.use_gpu=False;match.num_threads=4;match.max_num_matches=12000;match.sift.cpu_brute_force_matcher=True
 ...
 pycolmap.match_sequential(DB,match,pair,verify,device=pycolmap.Device.cpu)
