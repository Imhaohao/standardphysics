...
const VARIANTS: Record<Variant, string> = {
  ...
  chip: "bg-sheet/95 text-ink shadow-[0_1px_2px_rgb(27_28_30/0.12),0_4px_16px_rgb(27_28_30/0.08)] hover:bg-sheet px-3 py-2 text-sm aria-pressed:bg-ink aria-pressed:text-paper",
};
